...
class ServoController:
    def __init__(self, channel=0, min_pulse=1000, max_pulse=2000):
...
def create_servo(channel=0, min_pulse=1000, max_pulse=2000):
    """Create and return a ServoController instance."""
    return ServoController(channel, min_pulse, max_pulse)